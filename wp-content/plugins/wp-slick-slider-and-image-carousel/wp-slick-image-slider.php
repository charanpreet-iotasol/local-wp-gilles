...
if( ! defined( 'WPSISAC_PLUGIN_LINK_UNLOCK' ) ) {
	define('WPSISAC_PLUGIN_LINK_UNLOCK','https://www.essentialplugin.com/wordpress-plugin/wp-slick-slider-and-image-carousel/?utm_source=WP&utm_medium=Slick-Slider&utm_campaign=Features-PRO'); // Plugin link
}
if( ! defined( 'WPSISAC_PLUGIN_LINK_UPGRADE' ) ) {
	define('WPSISAC_PLUGIN_LINK_UPGRADE','https://www.essentialplugin.com/wordpress-plugin/wp-slick-slider-and-image-carousel/?utm_source=WP&utm_medium=Slick-Slider&utm_campaign=Upgrade-PRO'); // Plugin Check link
}

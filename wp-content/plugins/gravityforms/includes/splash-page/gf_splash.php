<article class="gform-splash" data-js="gform-splash-page">
	...
	<div class="gform-splash__body">
		...
		$text  = '<h3>' . __( 'What’s New with 2.6!', 'gravityforms ' ) . '</h3>
			...
			<a href="https://www.gravityforms.com/blog/gravity-forms-2-6-release" target="_blank" class="gform-button gform-button--size-r gform-button--white">' . __( 'Read More', 'gravityforms' ) . ' <span class="gform-visually-hidden">' . __( 'about the Gravity Forms 2.6 release', 'gravityforms' ) . '</span></a>';
		$image = array(
		...
		$text  = '<h3>' . __( 'An Inline Form Submit Button', 'gravityforms ' ) . '</h3>
			...
			<a href="https://docs.gravityforms.com/submit-button" target="_blank" class="gform-button gform-button--size-r gform-button--white">' . __( 'Read More', 'gravityforms' ) . ' <span class="gform-visually-hidden">' . __( 'about the inline form submit button', 'gravityforms' ) . '</span></a>';
		$image = array(
		...
		$text  = '<h3>' . __( 'A New Form Embed Process', 'gravityforms ' ) . '</h3>
			...
			<a href="https://docs.gravityforms.com/embed-form-flyout/" target="_blank" class="gform-button gform-button--size-r gform-button--white">' . __( 'Read More', 'gravityforms' ) . ' <span class="gform-visually-hidden">' . __( 'about the new Embed Form flyout', 'gravityforms' ) . '</span></a>';
		$image = array(
		...
		$text  = '<h3>' . __( 'An Updated Choices UI', 'gravityforms ' ) . '</h3>
			...
			<a href="https://docs.gravityforms.com/edit-choices-flyout/" target="_blank" class="gform-button gform-button--size-r gform-button--white">' . __( 'Read More', 'gravityforms' ) . ' <span class="gform-visually-hidden">' . __( 'about the updated Choices UI', 'gravityforms' ) . '</span></a>';
		$image = array(

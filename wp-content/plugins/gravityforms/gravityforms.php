...
class GFForms {
	...
	*/
	...
	public static function register_scripts() {
		...
		wp_register_style( 'gform_admin_components', $base_url . "/assets/css/dist/admin-components{$min}.css", array(), $version );
		...
		wp_register_style( 'gform_admin_icons', $base_url . "/assets/css/dist/admin-icons{$min}.css", array( 'gform_admin_ie11' ), $version );
		wp_register_style( 'gform_admin', $base_url . "/assets/css/dist/admin{$min}.css", array( 'gform_admin_icons', 'gform_admin_components', 'gform_admin_css_utilities'  ), $version );
	...
	public static function enqueue_admin_scripts( $hook ) {
		...
		if ( $load_scripts_globally && ! in_array( 'gform_gravityforms_admin', $scripts ) ) {
			$scripts[] = 'gform_gravityforms_admin';
		}

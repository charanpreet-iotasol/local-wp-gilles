...
<div id="Top_bar" class="loading">
	...
	<div class="container navbar-logo-container wrap-logo">
		<div class="column one">
			<div class="top_bar_left clearfix">
				<div class="row">
					<div class="col-sm-4">
						<div class="header-phone">
							<p class="big">For immediate assistance, call:</p>
							<h3 class="phone"><i class="icon-phone" style="color:#000000"></i><a href="tel:4357235236">(435)-723-5236 </a></h3>
							<button type="button">Get Directions<i class="icon-direction" ></i></button>
                		</div>
					</div>
					<div class="col-sm-5">
